...
export class GameScene extends Scene
{
  ...
  public draw( now: number, delta: number ): void
  {
    ...
    drawQuad( this.root.topLeft.x, this.root.topLeft.y, this.root.size.x, 51 );
    drawQuad( this.root.topLeft.x, this.root.topLeft.y + this.root.size.y - 110, this.root.size.x, 110 );
    drawQuad( this.root.topLeft.x, this.root.topLeft.y + this.root.size.y / 2 - 25, this.root.size.x, 50 );
    ...
    for ( const [ phase, text ] of this.phases )
    {
      ...
      drawQuad( this.root.topLeft.x + this.root.size.x - 92, this.root.topLeft.y + this.root.size.y - 105 + ( i * 10 ) - 2, 85, 9 );
    ...
    if ( this.phase === GamePhase.Player && GameState.playerMode !== "play" )
    {
      ...
      drawQuad( this.root.topLeft.x, this.root.topLeft.y, this.root.size.x, this.root.size.y - 110 );
