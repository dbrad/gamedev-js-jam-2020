import { Align, drawText, drawTexture, parseText, textHeight, drawQuad } from "../core/draw";
...
export class EncountersActiveNode extends SceneNode
{
  ...
  public draw( now: number, delta: number ): void
  {
    ...
    if ( this.tooltipCard )
    {
      ...
      drawQuad( topLeft.x, topLeft.y, 102, height + 2 );
      gl.colour( 0xFF0E0803 );
      drawQuad( topLeft.x + 1, topLeft.y + 1, 100, height );
